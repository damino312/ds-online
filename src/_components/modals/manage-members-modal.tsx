        ...
        <DialogHeader>
          ...
          {/* <ScrollArea className="max-h-[400px] rounded-md p-4"> */}
            {members
              ?.sort((a, b) => {
                if (
                  a.member_role === MemberRole.ADMIN &&
                  b.member_role !== MemberRole.ADMIN
                ) {
                  return -1;
                }
                if (
                ...
                if (
                  a.member_role === MemberRole.MODERATOR &&
                  b.member_role !== MemberRole.MODERATOR
                ) {
                  return -1;
                }
                if (
              ...
              .map((member) => {
                ...
                return (
                  <div
                    ...
                    className="w-full px-3 py-1 rounded-xl flex items-center justify-between border-zinc-500 border-[1px] mb-2"
                  >
                    ...
                    {isLoadingId === member.member_id ? (
                      <Loader2Icon className="w-6 h-6 animate-spin text-black " />
                    ) : (
                      session.data?.user?.id !== member.profile.user_id && (
                        <DropdownMenu>
                          <DropdownMenuTrigger>
